...
import useDiscoveredGalleryImages from "../../hooks/useDiscoveredGalleryImages";
...
// VIDEOS
//
// Served straight from /public/videos so they are NOT
// bundled into the JS chunk graph — the browser only
// fetches metadata (via preload="metadata" below) until
// someone actually presses play. Keeps the initial page
// weight small on mobile connections.
// =====================================================

const galleryVideo1 = "/videos/gallery1.mp4";
const galleryVideo2 = "/videos/gallery2.mp4";
const galleryVideo3 = "/videos/gallery3.mp4";

const content = {
  ta: {
    badge: "எங்கள் நினைவுகள்",
    headingA: "ஒவ்வொரு விழாவும்",
    headingB: "ஒரு இனிய நினைவு",
    description:
      "நளன் கேட்டரிங் வழங்கும் திருமணம், பிறந்தநாள், குடும்ப விழாக்கள் மற்றும் சிறப்பு நிகழ்வுகளின் அழகான தருணங்களை காணுங்கள்.",
    photosTitle: "புகைப்படங்கள்",
    photosSub: "Swipe or tap to explore",
    videosTitle: "வீடியோ தருணங்கள்",
    videosSub: "Watch our catering moments",
    bottomLine: "தமிழ் பாரம்பரியம் • சுவையின் பெருமை",
    images: [
      { src: galleryImage1, alt: "நளன் கேட்டரிங் திருமண உணவு சேவை - திருச்சி" },
      { src: galleryImage2, alt: "நளன் கேட்டரிங் பாரம்பரிய தமிழ் உணவு" },
      { src: galleryImage3, alt: "நளன் கேட்டரிங் விழா உணவு அமைப்பு" },
      { src: galleryImage4, alt: "நளன் கேட்டரிங் திருமண உணவு சேவை" },
      { src: galleryImage5, alt: "நளன் கேட்டரிங் பாரம்பரிய தென்னிந்திய உணவு சேவை" },
    ],
    videos: [
      { src: galleryVideo1, title: "வாடிக்கையாளர் கருத்து" },
      { src: galleryVideo2, title: "நிகழ்வு மற்றும் உணவு சேவை" },
      { src: galleryVideo3, title: "கொண்டாட்டம் மற்றும் கேட்டரிங் சேவை" },
    ],
  },
  en: {
    badge: "Our Memories",
    headingA: "Every Celebration,",
    headingB: "A Sweet Memory",
    description:
      "Take a look at beautiful moments from the weddings, birthdays, family functions, and special occasions catered by Nalan Catering.",
    photosTitle: "Photos",
    photosSub: "Swipe or tap to explore",
    videosTitle: "Video Moments",
    videosSub: "Watch our catering moments",
    bottomLine: "Tamil Tradition • The Pride of Flavour",
    images: [
      { src: galleryImage1, alt: "Nalan Catering wedding catering service in Trichy" },
      { src: galleryImage2, alt: "Traditional Tamil food catering by Nalan Catering" },
      { src: galleryImage3, alt: "Nalan Catering food arrangement for a special event" },
      { src: galleryImage4, alt: "Wedding food and catering service by Nalan Catering" },
      { src: galleryImage5, alt: "Traditional South Indian catering service in Trichy" },
    ],
    videos: [
      { src: galleryVideo1, title: "Nalan Catering customer feedback" },
      { src: galleryVideo2, title: "Nalan Catering event and food service" },
      { src: galleryVideo3, title: "Nalan Catering celebration and catering service" },
    ],
  },
};
...
function Gallery() {
  ...
  // DATA
  //
  // Any extra photos dropped straight into
  // /public/gallery (named 1.jpg, 2.jpg, 3.jpg...) are
  // discovered at runtime and appended automatically —
  // no rebuild needed. See public/gallery/README.txt.
  // ===================================================

  const discoveredImages = useDiscoveredGalleryImages("/gallery", 40);

  const images = [...t.images, ...discoveredImages];
