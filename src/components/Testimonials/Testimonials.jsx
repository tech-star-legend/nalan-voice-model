...
const content = {
  ta: {
    badge: "எங்கள் வாடிக்கையாளர்களின் கருத்துகள்",
    headingA: "எங்களைப் பற்றி",
    headingB: "அவர்கள் சொல்வது",
    description:
      "எங்கள் உணவு மற்றும் சேவையை அனுபவித்த வாடிக்கையாளர்களின் அன்பான கருத்துகள்.",
    testimonials: [
      {
  ...
  en: {
    ...
    headingA: "What They're",
    headingB: "Saying About Us",
    description:
      "Warm words from customers who experienced our food and our service first-hand.",
    testimonials: [
      {
        name: "Priya & Family",
        event: "Wedding Function",
        text: "The food was incredibly tasty and top quality. Every single dish had exactly the right flavour. Nalan Catering gave outstanding service at our wedding.",
      },
      {
        name: "Karthik",
        event: "Family Function",
        text: "The taste of the food was wonderful, and the way it was served was excellent too. Everyone at the event was full of praise for the food.",
      },
      {
        name: "Suresh",
        event: "Birthday Party",
        text: "Delicious food and great service. The catering team worked with real dedication. Thank you for helping make our celebration a success.",
      },
      {
        name: "Ramesh",
        event: "Engagement Ceremony",
        text: "Both the quality and the taste of the food were excellent. Every dish was prepared cleanly and neatly. I'd definitely recommend Nalan Catering.",
      },
      {
        name: "Anitha",
        event: "Auspicious Function",
        text: "The food tasted just like home cooking. The catering service was delivered beautifully and right on time. We were extremely satisfied.",
      },
      {
        name: "Vignesh",
        event: "Ear-Piercing Ceremony",
        text: "Everything from the food to the serving was outstanding. All the guests loved the food. Truly excellent catering service.",
      },
      {
        name: "Mahesh & Family",
        event: "Wedding Reception",
        text: "The dishes were tailored wonderfully to our guests' tastes. Nalan Catering excelled in flavour, quality, and service alike.",
      },
      {
        name: "Deepa",
        event: "Family Function",
        text: "Every vegetarian dish was so tasty, and the quality of the food was excellent. The staff's approach was also very warm and caring.",
      },
      {
        name: "Aravind",
        event: "Special Occasion",
        text: "The food was even better than we expected — delicious dishes, neat serving, and great service. Heartfelt thanks to Nalan Catering.",
      },
      {
        name: "Krishna",
        event: "Celebration Event",
        text: "The taste of the food was wonderful. Every dish was fresh and top quality. We received great compliments from everyone at the event.",
      },
    ],
  },
};
