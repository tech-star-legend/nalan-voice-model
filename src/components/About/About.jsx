...
const content = {
  ta: {
    label: "எங்களை பற்றி",
    headingA: "தரமான உணவு",
    headingB: "சிறந்த சேவை",
    paragraph1:
      "நளன் கேட்டரிங் கடந்த 40+ ஆண்டுகளாக திருமணங்கள், நிச்சயதார்த்தங்கள், பிறந்தநாள் விழாக்கள் மற்றும் Corporate Events ஆகியவற்றிற்கு தரமான உணவு மற்றும் சிறந்த சேவையை வழங்கி வருகிறது.",
    paragraph2:
    ...
    imageBadge: "பாரம்பரிய சுவை • நவீன சேவை",
    legacyLabel: "எங்கள் பாரம்பரியம்",
    legacyHeading: "மூன்று தலைமுறைகளின் பயணம்",
    legacyParagraph:
      "பாரம்பரியத்தை தொடர்ந்து, தரமான உணவையும் அன்பான சேவையையும் தலைமுறை தலைமுறையாக வழங்கி வருகிறோம்.",
    stats: [
      { number: "50,000+", title: "வெற்றிகரமான நிகழ்வுகள்" },
      { number: "40+", title: "ஆண்டுகள் அனுபவம்" },
      { number: "100%", title: "வாடிக்கையாளர்களின் திருப்தி" },
    ],
    owners: [
      {
        image: thathaImage,
  ...
  en: {
    label: "About Us",
    headingA: "Quality Food",
    headingB: "Exceptional Service",
    paragraph1:
      "For more than 40 years, Nalan Catering has delivered quality food and outstanding service for weddings, engagements, birthday celebrations, and corporate events.",
    paragraph2:
      "Our goal isn't just to serve delicious food — it's to turn your event into an experience everyone will remember.",
    imageBadge: "Traditional Taste • Modern Service",
    legacyLabel: "Our Legacy",
    legacyHeading: "A Journey Across Three Generations",
    legacyParagraph:
      "Carrying our tradition forward, we've served quality food and loving hospitality from one generation to the next.",
    stats: [
      { number: "50,000+", title: "Successful Events" },
      { number: "40+", title: "Years of Experience" },
    ...
    owners: [
      {
        ...
        alt: "Nalan Catering Founder",
      },
      {
        image: appaImage,
        title: "Second Generation",
        subtitle: "Carrying the Tradition Forward",
        alt: "Nalan Catering Second Generation",
      },
      {
        image: maganImage,
        title: "Third Generation",
        subtitle: "A New Generation, the Same Tradition",
        alt: "Nalan Catering Third Generation",
      },
    ],
  },
};
...
function About() {
  ...
  const stats = t.stats.map((item, index) => ({
    ...item,
    icon: [
      <UtensilsCrossed size={25} key="0" />,
      <Award size={25} key="1" />,
      <Users size={25} key="2" />,
    ][index],
  }));
